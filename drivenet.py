...
# The  layer is a convolutional layer with 32 filters, each of size (5,5)
model.add(MaxPooling2D(pool_size=(2, 2)))
# The  layer is a max pooling layer with a pool size of (2,2)
model.add(Conv2D(64, kernel_size=(3, 3), activation='relu'))
# The  layer is another convolutional layer with 64 filters, each of size (3,3), and ReLU activation.
model.add(MaxPooling2D(pool_size=(2, 2)))
# The  layer is another max pooling layer with a pool size of (2,2).
model.add(Flatten())
# The  layer is a flatten layer, which flattens the 2D output of the previous layer into a 1D vector.
